...
`)])],-1),k=s("div",{class:"card"},[s("h3",null,"Components Playground"),s("p",null,[a("We provide a web version of the component editor, which is convenient for you to quickly get started with each component of the component library, edit it online, share it with others, or download the code package to run locally. You can click the "),s("code",null,"{...}"),a(" icon in the upper right corner of the page or "),s("a",{href:"https://varlet.gitee.io/varlet-ui-playground"},"go here")])],-1);function w(b,x,V,A,B,C){const n=c("var-site-code-example");return o(),p("div",i,[h,d,s("div",m,[u,j,_,t(n,{"playground-ignore":""},{default:l(()=>[g]),_:1}),v,t(n,{"playground-ignore":""},{default:l(()=>[y]),_:1}),t(n,{"playground-ignore":""},{default:l(()=>[f]),_:1})]),k])}var I=e(r,[["render",w]]);export{I as default};
