...
`)])],-1),O={class:"card"},L=s("h3",null,"Vite",-1),P=s("p",null,[l("Vite do not support "),s("code",null,"~"),l(" syntax and need to override "),s("code",null,"~"),l(".")],-1),U=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// vite.config.js"),l(`
...
`)])],-1);function q(D,H,I,K,M,W){const n=t("var-site-code-example");return c(),r("div",p,[h,d,s("div",u,[m,j,a(n,null,{default:e(()=>[_]),_:1})]),b,s("div",f,[v,a(n,null,{default:e(()=>[g]),_:1})]),s("div",y,[x,a(n,null,{default:e(()=>[w]),_:1})]),s("div",z,[V,a(n,null,{default:e(()=>[k]),_:1})]),C,s("div",T,[$,E,a(n,null,{default:e(()=>[S]),_:1})]),s("div",N,[B,a(n,null,{default:e(()=>[F]),_:1})]),s("div",O,[L,P,a(n,null,{default:e(()=>[U]),_:1})])])}var G=o(i,[["render",q]]);export{G as default};
