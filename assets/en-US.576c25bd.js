import{_ as o}from"./elevation.491afd1d.js";import{e as n,o as l,c,a as t,i as a,j as d,U as r,m as e}from"./vendor.49f89f0d.js";const i={components:{}},h={class:"varlet-site-doc"},p=t("h1",null,"ImagePreview",-1),m=t("div",{class:"card"},[t("h3",null,"Intro"),t("p",null,"Image-Preview, Support double-click magnification, Support function call and component call two ways.")],-1),g={class:"card"},j=t("h3",null,"Install",-1),u=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"import"),e(" { createApp } "),t("span",{class:"hljs-keyword"},"from"),e(),t("span",{class:"hljs-string"},"'vue'"),e(`
...
`)])],-1),v={class:"card"},w=t("h3",null,"Scoped Install",-1),b=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"import"),e(" { ImagePreview } "),t("span",{class:"hljs-keyword"},"from"),e(),t("span",{class:"hljs-string"},"'@varlet/ui'"),e(`
...
`)])],-1),_={class:"card"},f=t("h3",null,"Function Call",-1),k=t("h4",null,"Basic Usage",-1),y=t("pre",{class:"hljs"},[t("code",null,[e("ImagePreview("),t("span",{class:"hljs-string"},"'https://varlet.gitee.io/varlet-ui/cat.jpg'"),e(`)
`)])],-1),S=t("h4",null,"Call Back",-1),x=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"const"),e(` images = [
...
`)])],-1),C=t("h2",null,"Component Call",-1),P={class:"card"},I=t("h3",null,"Basic Use",-1),T=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[e("<"),t("span",{class:"hljs-name"},"var-button"),e(`
...
/>`)]),e(`
`)])],-1),U=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"import"),e(" { ref } "),t("span",{class:"hljs-keyword"},"from"),e(),t("span",{class:"hljs-string"},"'vue'"),e(`
