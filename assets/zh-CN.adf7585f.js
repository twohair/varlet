...
`)])],-1),k=s("p",null,[l("\u6CE8\u5165\u7EC4\u4EF6\u5E93\u63A8\u8350\u7684"),s("code",null,"\u6587\u5B57\u989C\u8272"),l("\u548C"),s("code",null,"\u80CC\u666F\u989C\u8272"),l("\u53D8\u91CF\u6765\u63A7\u5236\u6574\u4F53\u989C\u8272")],-1),g=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* playground-ignore */"),l(`
`),s("span",{class:"hljs-selector-tag"},"body"),l(` {
  `),s("span",{class:"hljs-attribute"},"transition"),l(": background-color ."),s("span",{class:"hljs-number"},"25s"),l(`;
  `),s("span",{class:"hljs-attribute"},"color"),l(": "),s("span",{class:"hljs-built_in"},"var"),l(`(--color-text);
  `),s("span",{class:"hljs-attribute"},"background-color"),l(": "),s("span",{class:"hljs-built_in"},"var"),l(`(--color-body);
}
`)])],-1);function v(f,y,b,w,x,T){const a=o("var-site-code-example");return c(),r("div",p,[d,i,s("div",u,[_,n(a,null,{default:e(()=>[j]),_:1}),n(a,null,{default:e(()=>[m]),_:1}),k,n(a,null,{default:e(()=>[g]),_:1})])])}var B=t(h,[["render",v]]);export{B as default};
