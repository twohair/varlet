import{_ as c,l as p,f as h,h as j,D as a,n,N as t,al as e,J as s}from"./vue-router.esm-bundler.deab6574.js";const o={components:{}},r={class:"varlet-site-doc"},d=e('<h1>Menu</h1><div class="card"><h3>Intro</h3><p>Enable elements to display a menu when clicked, freely control the display position of the menu by controlling the alignment and offset of the menu.</p></div><div class="card"><h3>Attention</h3><p>Menu is an <code>inline block</code> element. When you click through the default slot, the menu will be displayed. If you want menu to monopolize a line, it is recommended to package a <code>block</code> element Menu is automatically closed in the area beyond the scope of the component, so you can\u2019t use the same state to bind <code>v-model:show</code>. Otherwise, when the display is triggered, other menu pairs are also triggered Menu cannot be displayed due to the modification of <code>v-model:show</code>.</p></div>',3),m={class:"card"},i=a("h3",null,"Alignment Methods",-1),g=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
