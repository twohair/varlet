...
`)])],-1);function v(b,k,y,f,T,x){const l=o("var-site-code-example");return r(),c("div",p,[i,d,s("div",m,[j,e(l,{"playground-ignore":""},{default:n(()=>[u]),_:1}),_,e(l,{"playground-ignore":""},{default:n(()=>[g]),_:1})])])}var N=t(h,[["render",v]]);export{N as default};
