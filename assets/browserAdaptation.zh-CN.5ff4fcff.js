...
`)])],-1);function y(N,C,V,k,$,B){const n=l("var-site-code-example");return c(),p("div",h,[i,u,s("div",_,[m,o(n,{"playground-ignore":""},{default:t(()=>[j]),_:1}),o(n,{"playground-ignore":""},{default:t(()=>[v]),_:1})]),s("div",x,[g,f,o(n,{"playground-ignore":""},{default:t(()=>[w]),_:1}),o(n,{"playground-ignore":""},{default:t(()=>[b]),_:1})])])}var T=e(d,[["render",y]]);export{T as default};
