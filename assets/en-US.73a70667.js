...
`)])],-1),v={class:"card"},m=e("h3",null,"Basic Usage",-1),_=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(" @"),e("span",{class:"hljs-attr"},"after-read"),s("="),e("span",{class:"hljs-string"},'"handleAfterRead"'),s("/>")]),s(`
`)])],-1),y=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-keyword"},"import"),s(" { ref } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),b={class:"card"},w=e("h3",null,"File Preview",-1),k=e("p",null,"By analyzing the file URL suffix name to determine the file type, support image and video preview.",-1),x=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s("/>")]),s(`
`)])],-1),F=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-keyword"},"import"),s(" { ref } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),V={class:"card"},R=e("h3",null,"Upload State",-1),z=e("p",null,[s("Three uploading states, "),e("code",null,"loading"),s(", "),e("code",null,"success"),s(" and "),e("code",null,"error"),s(", are provided, and tool functions are provided to quickly obtain files with corresponding states.")],-1),T=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(" @"),e("span",{class:"hljs-attr"},"after-read"),s("="),e("span",{class:"hljs-string"},'"handleAfterRead"'),s("/>")]),s(`
`)])],-1),S=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-keyword"},"import"),s(" { ref } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),A={class:"card"},U=e("h3",null,"File Maxlength",-1),D=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(),e("span",{class:"hljs-attr"},":maxlength"),s("="),e("span",{class:"hljs-string"},'"1"'),s("/>")]),s(`
`)])],-1),B={class:"card"},C=e("h3",null,"File Size Limit",-1),P=e("p",null,[s("If the limit is exceeded, the file will be blocked. You can get the file by listening for the "),e("code",null,"oversize"),s(" event.")],-1),G=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(),e("span",{class:"hljs-attr"},":maxsize"),s("="),e("span",{class:"hljs-string"},'"1024"'),s(" @"),e("span",{class:"hljs-attr"},"oversize"),s("="),e("span",{class:"hljs-string"},'"handleOversize"'),s(" />")]),s(`
`)])],-1),M=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-keyword"},"import"),s(" { ref } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'vue'"),s(`
`),e("span",{class:"hljs-keyword"},"import"),s(" { Snackbar } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'@varlet/ui'"),s(`

`),e("span",{class:"hljs-keyword"},"export"),s(),e("span",{class:"hljs-keyword"},"default"),s(` {
  `),e("span",{class:"hljs-function"},[e("span",{class:"hljs-title"},"setup"),s("("),e("span",{class:"hljs-params"}),s(")")]),s(` {
    `),e("span",{class:"hljs-keyword"},"const"),s(` files = ref([])

    `),e("span",{class:"hljs-keyword"},"const"),s(" handleOversize = "),e("span",{class:"hljs-function"},"() =>"),s(` {
      Snackbar.warning(`),e("span",{class:"hljs-string"},"'file size exceeds limit'"),s(`)
    }
...
`)])],-1),E={class:"card"},I=e("h3",null,"Upload Preprocessing",-1),O=e("p",null,[s("Operate on a file by registering a "),e("code",null,"before-read"),s(" event that returns a false value to prevent the file from being read.")],-1),W=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(" @"),e("span",{class:"hljs-attr"},"before-read"),s("="),e("span",{class:"hljs-string"},'"handleBeforeRead"'),s("/>")]),s(`
`)])],-1),N=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-keyword"},"import"),s(" { ref } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'vue'"),s(`
`),e("span",{class:"hljs-keyword"},"import"),s(" { Snackbar } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'@varlet/ui'"),s(`
...
`),e("span",{class:"hljs-keyword"},"export"),s(),e("span",{class:"hljs-keyword"},"default"),s(` {
  `),e("span",{class:"hljs-function"},[e("span",{class:"hljs-title"},"setup"),s("("),e("span",{class:"hljs-params"}),s(")")]),s(` {
    ...
    `),e("span",{class:"hljs-keyword"},"const"),s(" handleBeforeRead = "),e("span",{class:"hljs-function"},[s("("),e("span",{class:"hljs-params"},"file"),s(") =>")]),s(` {
      `),e("span",{class:"hljs-keyword"},"if"),s(" (file.file.size <= "),e("span",{class:"hljs-number"},"1"),s(" * "),e("span",{class:"hljs-number"},"1024"),s(" * "),e("span",{class:"hljs-number"},"1024"),s(`) {
        Snackbar.success(`),e("span",{class:"hljs-string"},"'the file is less than 1M, the upload is successful'"),s(`)
        `),e("span",{class:"hljs-keyword"},"return"),s(),e("span",{class:"hljs-literal"},"true"),s(`
      } `),e("span",{class:"hljs-keyword"},"else"),s(` {
        Snackbar.warning(`),e("span",{class:"hljs-string"},"'the file is larger than 1M and cannot be uploaded'"),s(`)
        `),e("span",{class:"hljs-keyword"},"return"),s(),e("span",{class:"hljs-literal"},"false"),s(`
      }
    }
...
`)])],-1),L={class:"card"},$=e("h3",null,"Disabled",-1),q=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"disabled"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s("/>")]),s(`
`)])],-1),H={class:"card"},Y=e("h3",null,"Readonly",-1),J=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"readonly"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s("/>")]),s(`
`)])],-1),K={class:"card"},Q=e("h3",null,"Remove Preprocessing",-1),X=e("p",null,[s("Before deleting the file, the "),e("code",null,"before-remove"),s(" event is triggered, and a falsy value is returned to prevent the delete operation.")],-1),Z=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(" @"),e("span",{class:"hljs-attr"},"remove"),s("="),e("span",{class:"hljs-string"},'"handleBeforeRemove"'),s(" />")]),s(`
`)])],-1),ee=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-keyword"},"import"),s(" { ref } "),e("span",{class:"hljs-keyword"},"from"),s(),e("span",{class:"hljs-string"},"'vue'"),s(`
...
`)])],-1),se={class:"card"},te=e("h3",null,"Customize upload styles",-1),de=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(),e("span",{class:"hljs-attr"},"v-model"),s("="),e("span",{class:"hljs-string"},'"files"'),s(">")]),s(`
...
`)])],-1),ae={class:"card"},le=e("h3",null,"Validate",-1),oe=e("p",null,[s("The values are validated by passing in an array of validator, If the validator returns "),e("code",null,"true"),s(", the validation passes. Other values are converted to text as a user prompt. The second argument is a collection of utility functions that can quickly get a collection of files that match the state.")],-1),ne=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-tag"},[s("<"),e("span",{class:"hljs-name"},"var-uploader"),s(`
