...
`)])],-1),v={class:"card"},m=s("h3",null,"Basic Usage",-1),_=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[e("<"),s("span",{class:"hljs-name"},"var-uploader"),e(),s("span",{class:"hljs-attr"},"v-model"),e("="),s("span",{class:"hljs-string"},'"files"'),e(" @"),s("span",{class:"hljs-attr"},"after-read"),e("="),s("span",{class:"hljs-string"},'"handleAfterRead"'),e("/>")]),e(`
`)])],-1),y=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),e(" { ref } "),s("span",{class:"hljs-keyword"},"from"),e(),s("span",{class:"hljs-string"},"'vue'"),e(`
...
`)])],-1),V={class:"card"},R=s("h3",null,"Upload State",-1),T=s("p",null,[e("Three uploading states, "),s("code",null,"loading"),e(", "),s("code",null,"success"),e(" and "),s("code",null,"error"),e(", are provided, and tool functions are provided to quickly obtain files with corresponding states.")],-1),z=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[e("<"),s("span",{class:"hljs-name"},"var-uploader"),e(),s("span",{class:"hljs-attr"},"v-model"),e("="),s("span",{class:"hljs-string"},'"files"'),e(" @"),s("span",{class:"hljs-attr"},"after-read"),e("="),s("span",{class:"hljs-string"},'"handleAfterRead"'),e("/>")]),e(`
...
/>`)]),e(`
`)])],-1),cs={class:"card"},rs=s("h3",null,"Custom render file list",-1),is=s("p",null,[e("You can use the "),s("code",null,"hide-list"),e(" to hiddeing component files list, then you can render this list by custom. This invalidates the "),s("code",null,"preview"),e(",and you can use "),s("code",null,"ImagePreview"),e(" to achieve the same function")],-1),hs=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[e("<"),s("span",{class:"hljs-name"},"div"),e(),s("span",{class:"hljs-attr"},"class"),e("="),s("span",{class:"hljs-string"},'"custom-uploader__file-list"'),e(">")]),e(`
  `),s("span",{class:"hljs-tag"},[e("<"),s("span",{class:"hljs-name"},"div"),e(),s("span",{class:"hljs-attr"},":key"),e("="),s("span",{class:"hljs-string"},'"f.id"'),e(),s("span",{class:"hljs-attr"},"v-for"),e("="),s("span",{class:"hljs-string"},'"f in files"'),e(">")]),e(`
    `),s("span",{class:"hljs-tag"},[e("<"),s("span",{class:"hljs-name"},"img"),e(`
      `),s("span",{class:"hljs-attr"},"class"),e("="),s("span",{class:"hljs-string"},'"custom-uploader__file-item"'),e(`
      `),s("span",{class:"hljs-attr"},":src"),e("="),s("span",{class:"hljs-string"},'"f.src"'),e(`
      `),s("span",{class:"hljs-attr"},"v-if"),e("="),s("span",{class:"hljs-string"},'"f.src"'),e(`
    />`)]),e(`
  `),s("span",{class:"hljs-tag"},[e("</"),s("span",{class:"hljs-name"},"div"),e(">")]),e(`
