...
`)])],-1);function y(k,C,A,B,N,V){const t=l("var-site-code-example");return c(),p("div",i,[h,u,s("div",m,[_,o(t,{"playground-ignore":""},{default:a(()=>[v]),_:1}),o(t,{"playground-ignore":""},{default:a(()=>[j]),_:1})]),s("div",g,[b,f,o(t,{"playground-ignore":""},{default:a(()=>[x]),_:1}),o(t,{"playground-ignore":""},{default:a(()=>[w]),_:1})])])}var S=n(d,[["render",y]]);export{S as default};
