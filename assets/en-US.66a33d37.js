...
`)])],-1);function x(y,b,w,k,$,B){const l=c("var-site-code-example");return o(),p("div",h,[r,d,s("div",j,[m,e(l,{"playground-ignore":""},{default:n(()=>[_]),_:1})]),s("div",v,[u,g,e(l,null,{default:n(()=>[f]),_:1})])])}var V=t(i,[["render",x]]);export{V as default};
