...
`)])],-1);function v(b,f,y,T,w,x){const l=o("var-site-code-example");return r(),c("div",d,[i,p,s("div",u,[m,a(l,null,{default:n(()=>[_]),_:1}),a(l,null,{default:n(()=>[j]),_:1}),g,a(l,{"playground-ignore":""},{default:n(()=>[k]),_:1})])])}var N=t(h,[["render",v]]);export{N as default};
