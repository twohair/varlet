import{_ as n}from"./elevation.de90c470.js";import{e as l,o as c,c as r,a as s,i as o,j as a,m as e,U as p}from"./vendor.a72d4487.js";const d={components:{}},i={class:"varlet-site-doc"},h=s("h1",null,"Browser Adaptation",-1),u=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,[e("The component library provides mobile and desktop adaptations, scheme "),s("code",null,"varlet-touch-emulator"),e(" is used for mobile terminal adaptation, scheme "),s("code",null,"varlet-touch-emulator"),e(" is used for mobile terminal adaptation.")])],-1),m={class:"card"},_=p("<h3>Mobile Adaptation</h3><p>The component library design is based on the <code>375px</code> width design draft. It is recommended to use PostCSS plugin to convert <code>px</code> units into <code>vw</code> units to achieve mobile terminal adaptation. Create <code>postcss.config.js</code> under the <code>Webpack/Vite</code> project root path And do the following configuration <code>375px -&gt; 100vw</code></p>",2),v=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),e(`
...
`)])],-1);function y(k,A,B,C,V,D){const t=l("var-site-code-example");return c(),r("div",i,[h,u,s("div",m,[_,o(t,{"playground-ignore":""},{default:a(()=>[v]),_:1}),o(t,{"playground-ignore":""},{default:a(()=>[j]),_:1})]),s("div",g,[b,f,o(t,{"playground-ignore":""},{default:a(()=>[x]),_:1}),o(t,{"playground-ignore":""},{default:a(()=>[w]),_:1})])])}var T=n(d,[["render",y]]);export{T as default};
