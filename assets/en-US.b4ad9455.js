...
`)])],-1),_=t("h2",null,"Functional",-1),k={class:"card"},v=t("h3",null,"Basic Use",-1),w=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s("Dialog("),t("span",{class:"hljs-string"},"'Don\\'t Wanna See No Blood, Don\\'t Be A Macho Man'"),s(`)
`)])],-1),D={class:"card"},C=t("h3",null,"Modify Title",-1),B=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`Dialog({
...
`)])],-1),S={class:"card"},x=t("h3",null,"Hide Button",-1),A=t("pre",{class:"hljs"},[t("code",null,[t("link",{rel:"stylesheet",href:"./highlight.css"}),s(`Dialog({
  `),t("span",{class:"hljs-attr"},"message"),s(": "),t("span",{class:"hljs-string"},"'Don\\'t Wanna See No Blood, Don\\'t Be A Macho Man'"),s(`,
