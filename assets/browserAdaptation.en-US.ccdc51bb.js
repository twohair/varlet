...
`)])],-1),v=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),e(`
`),s("span",{class:"hljs-comment"},"// postcss.config.js"),e(`
...
`)])],-1),g={class:"card"},b=s("h3",null,"Desktop Adaptation",-1),f=s("p",null,[e("Because component library interaction events are developed using "),s("code",null,"touch"),e(" events, "),s("code",null,"mouse"),e(" events on the desktop side are not supported. It is recommended to use "),s("code",null,"@varlet/touch-emulator"),e(" to set "),s("code",null,"touch -> mouse"),e(" for desktop adaptation.")],-1),x=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," playground-ignore"),e(`
`),s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," npm"),e(`
npm i @varlet/touch-emulator
`),s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," yarn"),e(`
yarn add @varlet/touch-emulator
`)])],-1),w=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),e(`
`),s("span",{class:"hljs-keyword"},"import"),e(),s("span",{class:"hljs-string"},"'@varlet/touch-emulator'"),e(`
`)])],-1);function y(k,A,B,C,V,D){const t=l("var-site-code-example");return c(),p("div",i,[h,u,s("div",m,[_,a(t,null,{default:n(()=>[j]),_:1}),a(t,null,{default:n(()=>[v]),_:1})]),s("div",g,[b,f,a(t,null,{default:n(()=>[x]),_:1}),a(t,null,{default:n(()=>[w]),_:1})])])}var T=o(d,[["render",y]]);export{T as default};
