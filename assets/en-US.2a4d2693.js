...
`)])],-1);function v(b,k,f,y,T,x){const e=o("var-site-code-example");return r(),c("div",p,[i,d,s("div",m,[j,l(e,{"playground-ignore":""},{default:t(()=>[u]),_:1}),_,l(e,null,{default:t(()=>[g]),_:1})])])}var B=n(h,[["render",v]]);export{B as default};
