...
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),w={class:"card"},S=s("h3",null,"Events",-1),z=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
  ...
  />`)]),a(`
`),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
`)])],-1),D={class:"card"},E=s("h3",null,"Custom Icons",-1),U=s("p",null,[a("First you need to set up your own font and install it into your project. Let\u2019s assume that we extend a font named "),s("code",null,"my-icons"),a(".")],-1),N=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"/* playground-ignore */"),a(`
`),s("span",{class:"hljs-comment"},"/* Set the font */"),a(`
...
`)])],-1),P=s("p",null,[a("Here you have successfully extended your icon library. So "),s("code",null,"my-icon"),a(" is your font "),s("code",null,"namespace"),a(". You can use it this way:")],-1),T=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"<!-- playground-ignore -->"),a(`
`),s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"template"),a(">")]),a(`
