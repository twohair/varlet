import{_ as t}from"./elevation.de90c470.js";import{e as c,o,c as p,a as s,i as e,j as n,m as a}from"./vendor.a72d4487.js";const i={components:{}},h={class:"varlet-site-doc"},r=s("h1",null,"Elevation",-1),j=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,[a("The component library provides a shadow elevation effect based on the "),s("code",null,"Material"),a(" specification to represent the dimensionality of an element.")])],-1),d={class:"card"},m=s("h3",null,"Import Style",-1),_=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),a(`
...
`)])],-1);function x(y,b,w,k,$,B){const l=c("var-site-code-example");return o(),p("div",h,[r,j,s("div",d,[m,e(l,null,{default:n(()=>[_]),_:1})]),s("div",u,[v,g,e(l,null,{default:n(()=>[f]),_:1})])])}var V=t(i,[["render",x]]);export{V as default};
