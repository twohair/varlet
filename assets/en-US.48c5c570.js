...
`)]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"style"),a(">")]),a(`
`)])],-1),w={class:"card"},k=s("h3",null,"Plugin",-1),L=s("p",null,[a("The option to set the default "),s("code",null,"Lazy"),a(" load option is provided, which is passed in at plugin registration.")],-1),A=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),a(`
...
`)])],-1),B=o('<h2>API</h2><div class="card"><h3>Plugin Options</h3><table><thead><tr><th>Option</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>loading</code></td><td>Loading images, if possible, select images that load quickly</td><td><em>string</em></td><td><code>Pixel transparent picture</code></td></tr><tr><td><code>error</code></td><td>Load failed to display the picture</td><td><em>string</em></td><td><code>Pixel transparent picture</code></td></tr><tr><td><code>attempt</code></td><td>The number of times a load failed to reload</td><td><em>number</em></td><td><code>3</code></td></tr><tr><td><code>throttleWait</code></td><td>throttle wait time, The higher the value, the lower the trigger frequency</td><td><em>number</em></td><td><code>300</code></td></tr><tr><td><code>events</code></td><td>A list of events that trigger visibility detection registration</td><td><em>string[]</em></td><td><code>[&#39;scroll&#39;...]</code></td></tr><tr><td><code>filter</code></td><td>Attribute interceptor function</td><td><em>(lazy: Lazy) =&gt; void</em></td><td><code>() =&gt; void</code></td></tr></tbody></table></div>',2);function P(T,I,N,V,$,S){const t=c("var-site-code-example");return r(),p("div",i,[d,j,s("div",m,[g,l(t,null,{default:n(()=>[u]),_:1})]),s("div",_,[v,l(t,null,{default:n(()=>[b]),_:1})]),s("div",y,[f,x,l(t,null,{default:n(()=>[z]),_:1})]),s("div",w,[k,L,l(t,null,{default:n(()=>[A]),_:1})]),B])}var C=e(h,[["render",P]]);export{C as default};
