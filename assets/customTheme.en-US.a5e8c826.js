...
`)])],-1),z={class:"card"},k=s("h3",null,"ES module based manual import",-1),V=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),l(),s("span",{class:"hljs-string"},"'@varlet/ui/es/button/style/less'"),l(`
...
`)])],-1),O={class:"card"},q=s("h3",null,"Vite",-1),L=s("p",null,[l("Vite do not support "),s("code",null,"~"),l(" syntax and need to override "),s("code",null,"~"),l(".")],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// vite.config.js"),l(`
...
`)])],-1);function U(D,H,I,K,M,W){const n=t("var-site-code-example");return c(),r("div",p,[h,d,s("div",u,[m,j,a(n,null,{default:e(()=>[_]),_:1})]),b,s("div",f,[v,a(n,null,{default:e(()=>[g]),_:1})]),s("div",y,[x,a(n,null,{default:e(()=>[w]),_:1})]),s("div",z,[k,a(n,null,{default:e(()=>[V]),_:1})]),C,s("div",T,[$,S,a(n,null,{default:e(()=>[E]),_:1})]),s("div",N,[B,a(n,null,{default:e(()=>[F]),_:1})]),s("div",O,[q,L,a(n,null,{default:e(()=>[P]),_:1})])])}var G=o(i,[["render",U]]);export{G as default};
