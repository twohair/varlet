...
`)])],-1),b={class:"card"},v=s("h3",null,"\u57FA\u672C\u4F7F\u7528",-1),_=s("p",null,[t("\u70B9\u51FB\u7D22\u5F15\u680F\u65F6\uFF0C\u4F1A\u81EA\u52A8\u8DF3\u8F6C\u5230\u5BF9\u5E94\u7684 "),s("code",null,"IndexAnchor"),t(" \u951A\u70B9\u4F4D\u7F6E\u3002")],-1),x=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-index-bar"),t(`
