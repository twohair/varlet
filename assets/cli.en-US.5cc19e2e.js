...
`)],-1),E=t("h4",null,"Preview documentation site",-1),G=t("pre",{class:"hljs"},[t("code",null,`varlet-cli preview
`)],-1),L=t("h4",null,"Build component library code",-1),$=t("pre",{class:"hljs"},[t("code",null,`varlet-cli compile
...
`)],-1),K=t("h4",null,"Lint commit message",-1),Q=t("pre",{class:"hljs"},[t("code",null,`varlet-cli commit-lint
