...
`)])],-1),k={class:"card"},_=s("h3",null,"\u5C40\u90E8\u5F15\u5165",-1),f=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ActionSheet } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'@varlet/ui'"),t(`
...
`)])],-1),y=s("h2",null,"\u51FD\u6570\u8C03\u7528",-1),w={class:"card"},v=s("h3",null,"\u57FA\u672C\u4F7F\u7528",-1),b=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { Snackbar } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'@varlet/ui'"),t(`
...
`)])],-1),S={class:"card"},I=s("h3",null,"\u4FEE\u6539\u6807\u9898",-1),A=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),t(`ActionSheet({
  `),s("span",{class:"hljs-attr"},"actions"),t(`: [
    {
      `),s("span",{class:"hljs-attr"},"name"),t(": "),s("span",{class:"hljs-string"},"'Item 01'"),t(`,
      `),s("span",{class:"hljs-attr"},"icon"),t(": "),s("span",{class:"hljs-string"},"'account-circle'"),t(`,
...
`)])],-1),x={class:"card"},C=s("h3",null,"\u7981\u7528\u9009\u9879",-1),$=s("p",null,[t("\u9009\u9879\u4F20\u5165 "),s("code",null,"disabled"),t(" \u53EF\u4EE5\u4F7F\u9009\u9879\u5904\u4E8E\u7981\u7528\u72B6\u6001\u3002")],-1),O=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),t(`ActionSheet({
  `),s("span",{class:"hljs-attr"},"actions"),t(`: [
    {
      `),s("span",{class:"hljs-attr"},"name"),t(": "),s("span",{class:"hljs-string"},"'Item 01'"),t(`,
      `),s("span",{class:"hljs-attr"},"icon"),t(": "),s("span",{class:"hljs-string"},"'account-circle'"),t(`,
...
`)])],-1),B={class:"card"},T=s("h3",null,"\u81EA\u5B9A\u4E49\u9009\u9879\u6837\u5F0F",-1),E=s("p",null,[t("\u9009\u9879\u63D0\u4F9B\u4E86\u53EF\u4EE5\u914D\u7F6E\u6837\u5F0F\u7684\u53C2\u6570\uFF0C\u5177\u4F53\u9009\u9879\u7684\u53C2\u6570\u53EF\u9009\u9879\u89C1 "),s("code",null,"Action \u7684\u6570\u636E\u7ED3\u6784"),t("\u3002")],-1),U=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { Snackbar } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'@varlet/ui'"),t(`
...
`),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-action-sheet"),t(`
  ...
  @`),s("span",{class:"hljs-attr"},"select"),t("="),s("span",{class:"hljs-string"},'"handleSelect"'),t(`
/>`)]),t(`
`)])],-1),ts=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`
`),s("span",{class:"hljs-keyword"},"import"),t(" { Snackbar } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'@varlet/ui'"),t(`
...
`),s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"var-action-sheet"),t(`
  ...
  @`),s("span",{class:"hljs-attr"},"select"),t("="),s("span",{class:"hljs-string"},'"handleSelect"'),t(`
/>`)]),t(`
`)])],-1),cs=s("pre",{class:"hljs"},[s("code",null,[s("link",{rel:"stylesheet",href:"./highlight.css"}),s("span",{class:"hljs-keyword"},"import"),t(" { ref } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'vue'"),t(`
`),s("span",{class:"hljs-keyword"},"import"),t(" { Snackbar } "),s("span",{class:"hljs-keyword"},"from"),t(),s("span",{class:"hljs-string"},"'@varlet/ui'"),t(`
