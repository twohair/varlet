import{_ as o}from"./elevation.de90c470.js";import{e as t,o as c,c as p,a as s,i as e,j as a,m as n}from"./vendor.a72d4487.js";const r={components:{}},i={class:"varlet-site-doc"},u=s("h1",null,"Import On Demand",-1),d=s("div",{class:"card"},[s("h3",null,"Intro"),s("p",null,"The on-demand import avoids the full import of components and can effectively reduce the size of the distribution package.")],-1),h={class:"card"},m=s("h3",null,"Manual Import",-1),j=s("p",null,[n("Each component is a "),s("code",null,"Vue plugin"),n(" and is composed of "),s("code",null,"component logic"),n(" and "),s("code",null,"style files"),n(". It is manually install and used as follows.")],-1),_=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),n(`
...
`)])],-1),g={class:"card"},f=s("h3",null,"Auto Import",-1),v=s("p",null,[n("All components declared in the template are automatically scanned by the plug-in. The "),s("a",{href:"https://github.com/antfu/unplugin-vue-components"},"unplugin-vue-components"),n(" will automatically import "),s("code",null,"component logic"),n(" and "),s("code",null,"style files"),n(" and "),s("code",null,"use components")],-1),y=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," playground-ignore"),n(`
`),s("span",{class:"hljs-meta"},"#"),s("span",{class:"bash"}," Install plugin"),n(`
...
`)])],-1),k=s("h4",null,"Vue Cli",-1),w=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),n(`
`),s("span",{class:"hljs-comment"},"// vue.config.js"),n(`
...
`)])],-1),b=s("h4",null,"Vite",-1),x=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-comment"},"// playground-ignore"),n(`
`),s("span",{class:"hljs-comment"},"// vite.config.js"),n(`
...
`)])],-1),C=s("p",null,[n("Special note: Function components called outside the template cannot be scanned by the plug-in, and styles still need to be introduced manually. For example, "),s("code",null,"Snackbar"),n(" is a functional component.")],-1);function B(D,A,U,R,$,N){const l=t("var-site-code-example");return c(),p("div",i,[u,d,s("div",h,[m,j,e(l,null,{default:a(()=>[_]),_:1})]),s("div",g,[f,v,e(l,null,{default:a(()=>[y]),_:1}),k,e(l,null,{default:a(()=>[w]),_:1}),b,e(l,null,{default:a(()=>[x]),_:1}),I,e(l,null,{default:a(()=>[V]),_:1}),C])])}var q=o(r,[["render",B]]);export{q as default};
